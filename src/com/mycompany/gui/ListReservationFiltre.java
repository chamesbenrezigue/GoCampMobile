 ...
 * @author chaima
 */
public class ListReservationFiltre extends Form{
             Form current;
public ListReservationFiltre(Resources res,Form previous, String DS,String DE){
...
Toolbar tb = new Toolbar();
        ...
        tb.setBackCommand("", e -> new ListeReservation(res,previous).showBack());

         Integer id_user=Userconnected.getId();
     
 
    
            ArrayList<ReservationMaterial> ReservationsFilter = new ArrayList();
ReservationsFilter =ServiceReservationMaterial.getInstance().getReservationsMaterialsFilter(DS, DE,id_user);
                for (ReservationMaterial r :ReservationsFilter ) {
 ...
 Button update = new Button ("Update",String.valueOf(r.getId()));
    ...
    @Override
       public void actionPerformed(ActionEvent evt){
           if (ServiceReservationMaterial.getInstance().DeleteReservationsMaterial(delete.getUIID())==true){
               ...
               new ListeReservation(res,current).show(); 
            }
           else{
    ...
    @Override
       public void actionPerformed(ActionEvent evt){
               new UpReservation(res,current,update.getUIID()).show(); 
            }
   });
