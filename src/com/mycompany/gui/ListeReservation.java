...
public class ListeReservation extends Form{
 ...
 public ListeReservation(Resources res,Form previous) {
...
Toolbar tb = new Toolbar();
        ...
        Reservations =ServiceReservationMaterial.getInstance().getAllReservationsMaterials(Userconnected.getId());
        //Search
...
new  ListReservationFiltre(res,current,dateS,dateE).show();
       }
    });
